...
# Subsequent sections are based on settings in this section, # you should not need to change anything in these other sections.
# ----------------------------------------------------------------------
IPHONEOS_BASESDK_VERSION=${IPHONEOS_BASESDK_VERSION-5.1}
IPHONE_SIMULATOR_BASESDK_VERSION=${IPHONE_SIMULATOR_BASESDK_VERSION-5.1}
